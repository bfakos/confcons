...
```{r}
(thresholds_glm <- confcons::thresholds(observations = dataset$occurrences,
                                        predictions = dataset$predictions_glm))
(thresholds_rf <- confcons::thresholds(observations = dataset$occurrences,
