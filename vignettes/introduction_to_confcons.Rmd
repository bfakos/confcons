...
A manuscript about the novel measures is in press at the scientific journal "Ecological Modelling". Once published, we'll cite it here, and you'll get much more information about the measures from that paper.
...
Let's open the environmental raster that contains four climatic layers at 800 m resolution in UTM projection:
...
plot(x = environment[["bio_5"]], axes = FALSE, col = cm.colors(255), colNA = "gray95")
