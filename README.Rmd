...
- a pair of consistence values (`DCP`, `DCPP`) that serve as proxies for transferability of our model.
...
This GitHub version of the package is now in stable state. A manuscript about the novel measures, *confidence* and *consistence*, is submitted to a scientific journal. Upon acceptance we aim to publish 'confcons' to [CRAN](https://cran.r-project.org/).
