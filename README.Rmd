...
This GitHub version of the package is now in stable state. A manuscript about the novel measures, *confidence* and *consistency*, is in press at the scientific journal "Ecological Modelling". Upon acceptance we aim to publish 'confcons' to [CRAN](https://cran.r-project.org/).
